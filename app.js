window.onload = async function () {
  ...
  let banInfoStr = `Current Known Prio Bans: ${bansJson.length} <br> Last Updated: 6 February 2022`;
  ...
  let muteInfoStr = `Current Known Mutes: ${mutesJson.length} <br> Last Updated: 6 February 2022`;
